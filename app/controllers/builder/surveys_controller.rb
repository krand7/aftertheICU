class Builder::SurveysController < Builder::BuilderController
  ...
  def create
    ...
    respond_to do |format|
      if @survey.save
        format.html { redirect_to builder_survey_path(@survey), notice: 'Survey was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @survey.update(survey_params)
        format.html { redirect_to builder_survey_path(@survey), notice: 'Survey was successfully updated.' }
  ...
  def survey_params
    params.require(:survey).permit(:name, :description, :status, :slug, :pediatric, :child_min_age, :child_max_age)
  end
end
